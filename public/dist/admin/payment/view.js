var Index = (function () {
    ...
    var handleDataTabelUser = function () {
        table = $("#tbl-payment").DataTable({
            ...
            serverSide: true,
            ajax: {
                url: url + "/admin/payment-method/list",
                type: "POST",
                data: {
                    _token: csrf_token,
                },
        ...
        $("#btn-delete").click(function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        url: url + "/admin/payment-method/delete",
                        data: {
                            _token: csrf_token,
                            dValue: aSelected,
                        },
    ...
    var handleAdd = function () {
        $("#form-add-payment").submit(function (e) {
            ...
            $.ajax({
                url: `${url}/admin/payment-method/save`,
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
    ...
    var handleButtonEdit = function () {
        $(document).on("click", ".btn-edits", function () {
            ...
            $.ajax({
                type: "POST",
                url: url + "/admin/payment-method/info",
                data: {
                    _token: csrf_token,
                    dvx: dvx,
                },
                ...
                success: function (response) {
                    ...
                    $("#payment-name-edit").val(responseData.name);
                },
            });
            handleUpdate(dvx);
        });
    ...
    var handleUpdate = function (dvx) {
        $("#form-edit-payment").submit(function (e) {
            ...
            $.ajax({
                url: `${url}/admin/payment-method/update`,
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
