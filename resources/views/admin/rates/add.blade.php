...
<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="p-4 sm:p-8 bg-white sm:rounded-lg">
                ...
                <form class="w-full p-2 mt-2" method="post" id="form-add-rate" action="javascript:;">
                    @csrf
                    <div class="mb-5">
                        ...
                        <select id="provider" name="provider"
                            ...
                            <option selected value="">Choose a provider</option>
    ...
    @push('custom_js')
        ...
        <script src="{{ asset('dist/admin/rate/add.min.js?xc=') . time() }}"></script>
    @endpush
</x-app-layout>
