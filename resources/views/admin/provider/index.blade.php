...
<x-app-layout>
    ...
    <dialog id="modal_upload_image" class="modal">
        <div class="modal-box">
            ...
            <h3 class="text-lg font-bold">Modal upload image provider</h3>
            <form action="javascript:;" id="form-upload-image" class="max-w-sm mx-auto">
                @csrf
                <div class="mb-5 mt-3">
                    <label for="provider-name-edit"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Image</label>
                    <input type="file" id="provider-image" name="provider_image"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="input provider image" required />
                </div>
                <button type="submit"
